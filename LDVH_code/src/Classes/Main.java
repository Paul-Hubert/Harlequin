...
public class Main {
	...
	public static void demoA() throws Exception {
		...
		livreDEMOA.getOneSection("Ile principale").addObjet(new Objet("une piece d'or", ty1));
		...
		livreDEMOA.createEnchainement("vous decidez de vous rendre sur l'ile au village grace a votre radeau et vous payer un homme avec de l'or a votre arrivee","Mer --> Village", livreDEMOA.getOneSection("Mer"), livreDEMOA.getOneSection("Village"),livreDEMOA.getObjets(objets4), livreDEMOA.getTypeObjets(typeobjet1));
